...
class BookingRepositoryTest {
    ...
    private final  User user = new User(1L, "dd", "sss");
    private final Item item = new Item(1L, "1", "1", true, null, 1L);
    private final  Booking booking = new Booking(1L, start, end, 1L, 1L, Status.APPROVED);
