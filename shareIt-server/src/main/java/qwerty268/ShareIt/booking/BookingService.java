...
public interface BookingService {
    ...
    List<BookingDTO> getBookingsOfUser(String state, Long userId, int from, int size);

    List<BookingDTO> getBookingsForOwner(String state, Long userId, int from, int size);
}
